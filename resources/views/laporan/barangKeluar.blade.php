                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-header">
                                    <h4>Cetak Laporan Barang Keluar </h4>
                                </div>
                                <div class="card-body">
                                    <div class="default-tab">
                                        ...
                                        <div class="tab-content pl-3 pt-5" id="nav-tabContent">
                                            ...
                                            <a href="/cetak-all-barang-keluar" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-print"></i>&nbsp;Cetak Data Barang</a>
                                            </div>
                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                            <form action="{{ route ('barangKeluarByYear')}}" class="form-horizontal">
                                            <div class="col-md-5">
