    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$p->kategori->nama}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$p->stok}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$p->supplier->nama}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$p->sumber_dana}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" value="{{$p->jumlah}}" disabled>
                </div>
            </div>
